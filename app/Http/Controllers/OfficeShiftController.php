...
class OfficeShiftController extends Controller {
	...
	public function store(Request $request)
	{
		...
		if ($logged_user->can('store-office_shift'))
		{
            ...
            // Horários de volta do intervalo
            $data['monday_break_in'] = $request->monday_in;
			$data['monday_break_out'] = $request->monday_out;
			$data['tuesday_break_in'] = $request->tuesday_in;
			$data['tuesday_break_out'] = $request->tuesday_out;
			$data['wednesday_break_in'] = $request->wednesday_in;
			$data['wednesday_break_out'] = $request->wednesday_out;
			$data['thursday_break_in'] = $request->thursday_in;
			$data['thursday_break_out'] = $request->thursday_out;
			$data['friday_break_in'] = $request->friday_in;
			$data['friday_break_out'] = $request->friday_out;
			$data['saturday_break_in'] = $request->saturday_in;
			$data['saturday_break_out'] = $request->saturday_out;
			$data['sunday_break_in'] = $request->sunday_in;
			$data['sunday_break_out'] = $request->sunday_out;
