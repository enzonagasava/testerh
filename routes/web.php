...
Route::group(['middleware' => ['XSS','checkDataTable']], function () use ($isCrmModuleExist) {
    ...
    Route::post('markAsRead', [RouteClosureHandlerController::class, 'markAsReadNotification'])->name('markAsRead');
    ...
    Route::prefix('staff')->group(function () {
        ...
        Route::get('documents/document/view/{id}', [EmployeeDocumentController::class, 'view'])->name('documents_document.view');
    ...
    Route::get('/fetch/related/', [LeaveController::class, 'fetchRelatedData']);
    ...
    Route::prefix('recruitment')->group(function () {
        ...
        Route::put('job_candidates/{id}/approve', [JobCandidateController::class, 'approve'])->name('job_candidates.approve');
        Route::put('job_candidates/{id}/reprove', [JobCandidateController::class, 'reprove'])->name('job_candidates.reprove');
    ...
    Route::get('/tickets/view-document/{id}', [SupportTicketController::class, 'viewDocument'])->name('tickets.viewDocument');
    ...
    Route::post('dynamic_dependent/fetch_districts_by_city', [DynamicDependent::class, 'fetchDistrictsByCity'])->name('dynamic_districts_by_city');
    ...
    Route::prefix('dynamic_variable')->group(function () {
        ...
        Route::get('/designation-by-department/{department_id}', [SupportTicketController::class, 'getDesignationsByDepartment']);
        Route::get('/department-by-company/{company_id}', [SupportTicketController::class, 'getDepartmentByCompany']);
