    ...
    <section>
        <div class="container-fluid">
                        ...
                        <div class="col-md-12">
                            <form method="post" id="filter_form" class="form-horizontal">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <button name="submit_form" id="submit_form" type="submit" class="btn btn-primary"><i class="fa fa fa-check-square-o"></i> {{trans('Get')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            <span class="attendace_mark_info mb-3">
                <small>{{trans('present')}} = P  , {{trans('Absent')}} = A  ,{{trans('Leave')}} = L  , {{trans('Holiday')}} = H  ,{{__('Off Day')}} = O</small>
            </span>
        </div>
