...
<script type="text/javascript">
    (function($) {
                    ...
                    },
                    {
                        ...
                        render: function (data) {
                            ...
                            if (data.is_publish == 1) {
                                return data.event_name + "<br><td><div class = 'badge badge-success'> ({{trans('published')}})</div></td><br>";
                            } else {
                                return data.event_name + "<br><td><div class = 'badge badge-danger'> ({{trans('unpublished')}})</div></td><br>"
                            }
                        }
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result.data.is_publish == 1)
                        $('#publish_id').html('{{trans('Published')}}');
                    else {
                        $('#publish_id').html('{{trans('Unpublished')}}');
                    }
        ...
        $(document).on('click', '#bulk_delete', function () {
            ...
            if (id.length > 0) {
                if (confirm('{{__('Delete Selection',['key'=>trans('Holiday')])}}')) {
                    $.ajax({
