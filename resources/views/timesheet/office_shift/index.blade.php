            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data) {
                        if (data.monday_in) {
                            return data.monday_in + ' {{trans('To')}} ' + data.monday_out;
                        } else {
                            return '';
                        }
                    }
                },
                {
                    ...
                    render: function (data) {
                        if (data.tuesday_in) {
                            return data.tuesday_in + ' {{trans('To')}} ' + data.tuesday_out;
                        } else {
                            return '';
                        }
                    }
                },
                {
                    ...
                    render: function (data) {
                        if (data.wednesday_in) {
                            return data.wednesday_in + ' {{trans('To')}} ' + data.wednesday_out;
                        } else {
                            return '';
                        }
                ...
                },
                {
                    ...
                    render: function (data) {
                        if (data.thursday_in) {
                            return data.thursday_in + ' {{trans('To')}} ' + data.thursday_out;
                        } else {
                            return '';
                        }
                    }
                },
                {
                    ...
                    render: function (data) {
                        if (data.friday_in) {
                            return data.friday_in + ' {{trans('To')}} ' + data.friday_out;
                        } else {
                            return '';
                        }
                    }
                },
                {
                    ...
                    render: function (data) {
                        if (data.saturday_in) {
                            return data.saturday_in + ' {{trans('To')}} ' + data.saturday_out;
                        } else {
                            return '';
                        }
                    }
                },
                {
                    ...
                    render: function (data) {
                        if (data.sunday_in) {
                            return data.sunday_in + ' {{trans('To')}} ' + data.sunday_out;
                        } else {
                            return '';
                        }
                    }
