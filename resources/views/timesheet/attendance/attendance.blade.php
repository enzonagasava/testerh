        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-title text-center"><h3>Presenças Diárias<span id="details_month_year"></span></h3></div>
                        ...
                        <div class="row">
                            <div class="col-md-6 offset-md-3 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="submit" class="filtering btn btn-primary"><i class="fa fa-search"></i> {{trans('Search')}}
                                        </button>
                                </div>
                            </div>
                        </div>
