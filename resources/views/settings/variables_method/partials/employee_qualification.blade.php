    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 id="EducationLevelModalLabel" class="modal-title">{{trans('Edit')}}</h5>
...
<div id="LanguageSkillEditModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 id="LanguageSkillModalLabel" class="modal-title">{{trans('Edit')}}</h5>
...
<div id="GeneralSkillEditModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 id="GeneralSkillModalLabel" class="modal-title">{{trans('Edit')}}</h5>
