                        ...
                        <div class="card-body">
                            ...
                            <form method="POST"  id="general_settings_form" action="{{route('general_settings.update',1)}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><strong>{{trans('Currency')}} *</strong></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($general_settings_data->currency_format == 'prefix')
                                                <label class="radio-inline">
                                                    <input type="radio" name="currency_format" value="prefix" checked> {{trans('Prefix')}}
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="currency_format" value="suffix"> {{trans('Suffix')}}
                                                </label>
                                            @else
                                                <label class="radio-inline">
                                                    <input type="radio" name="currency_format" value="prefix"> {{trans('Prefix')}}
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="currency_format" value="suffix" checked> {{trans('Suffix')}}
                                                </label>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="account_id" id="account_id"  class="form-control selectpicker" required
                                                    ...
                                                    title='{{__('Selecting',['key'=>trans('Account')])}}...'>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mt-4 form-check">
                                            ...
                                            <label class="mr-4 form-check-label"><strong>{{trans('RTL Layout')}} </strong></label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mt-4 form-check">
                                            <input type="checkbox" name="enable_clockin_clockout" class="form-check-input" value="1" {{env('ENABLE_CLOCKIN_CLOCKOUT')!=NULL ? 'checked':''}}/>
                                            <label class="mr-4 form-check-label"><strong>{{trans('Enable Clock In and Clock Out')}} </strong></label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mt-4 form-check">
                                            <input type="checkbox" name="enable_early_clockin" class="form-check-input" value="1" {{env('ENABLE_EARLY_CLOCKIN')!=NULL ? 'checked':''}}/>
                                            <label class="mr-4 form-check-label"><strong>{{trans('Enable Early Clock In (Added to Worktime)')}} </strong></label>
                                        </div>
                                    </div>
                                    {{-- <div class="col-md-6">
                                        <div class="form-group mt-4">
                                            <label><strong>{{__('Attendance Device Date Format')}}</strong></label>
                                ...
                                <div class="d-flex justify-content-center">
                                    <input type="submit" id="submit" value="{{trans('submit')}}" class="btn btn-primary btn-lg btn-block">
                                </div>
                            </form>
                        </div>
                    </div>
