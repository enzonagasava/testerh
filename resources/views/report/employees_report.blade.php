                                    ...
                                    <div class="col-md-12">
                                        <form method="post" id="filter_form" class="form-horizontal">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="designation_id">{{trans('Designation')}}</label>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-actions">
                                                            <button type="submit" class="filtering btn btn-primary"><i
                                                                        class="fa fa-check-square-o"></i> {{trans('Search')}}
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            if ($(this).val() !== '') {
                ...
                $.ajax({
                    ...
                    success:function(result)
                    {
                        ...
                        $('.default_dept').prepend('<option value="0" selected>{{trans('All')}}</option>');
                        $('select').selectpicker();
                    }
                });
            }
            ...
            if ($(this).val() !== '') {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('.default_desig').prepend('<option value="0" selected>{{trans('All')}}</option>');
                        $('select').selectpicker();
