...
$('#bank_account-table').DataTable().clear().destroy();
    ...
    $('#create_bank_account_record').click(function () {
        ...
        $('#bank_account_action_button').val('{{trans('Add')}}');
        $('#bank_account_action').val('{{trans('Add')}}');
        $('#BankAccountformModal').modal('show');
    });

    $('#bank_account_sample_form').on('submit', function (event) {
        event.preventDefault();
        if ($('#bank_account_action').val() == '{{trans('Add')}}') {
        ...
        if ($('#bank_account_action').val() == '{{trans('Edit')}}') {
            $.ajax({
    ...
    $(document).on('click', '.bank_account_edit', function () {
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                $('#bank_account_action_button').val('{{trans('Edit')}}');
                $('#bank_account_action').val('{{trans('Edit')}}');
                $('#BankAccountformModal').modal('show');
            }
        })
    });
