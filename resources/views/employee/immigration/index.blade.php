<section>
    ...
    @if(auth()->user()->can('store-details-employee') || auth()->user()->id == $employee->id)
        <button type="button" class="btn btn-info" name="create_record" id="create_immigration_record"><i class="fa fa-plus"></i>Adicionar Documento</button>
    @endif
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" name="ok_button"  class="btn btn-danger immigration-ok">{{trans('OK')}}</button>
                    <button type="button" class="immigration-close btn btn-default" data-dismiss="modal">{{trans('Cancel')}}</button>
                </div>
            </div>
        </div>
    </div>
