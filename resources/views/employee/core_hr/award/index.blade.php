            ...
            <ul class="nav nav-tabs vertical" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="employee_award-tab" data-toggle="tab" href="#Employee_award"
                       role="tab" aria-controls="Employee_award" aria-selected="true">{{trans('Award')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#Employee_travel" id="employee_travel-tab"
                       ...
                       aria-controls="Employee_travel" aria-selected="false">{{trans('Travel')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('employee_training.index',$employee)}}" id="employee_training-tab"
                       ...
                       aria-controls="Employee_training" aria-selected="false">{{trans('Training')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#Employee_ticket" id="employee_ticket-tab"
                       ...
                       aria-controls="Employee_ticket" aria-selected="false">{{trans('Ticket')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('employee_transfer.show',$employee)}}" id="employee_transfer-tab"
                       ...
                       aria-controls="Employee_transfer" aria-selected="false">{{trans('Transfer')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('employee_promotion.show',$employee)}}"
                       ...
                       aria-controls="Employee_promotion" aria-selected="false">{{trans('Promotion')}}</a>
                </li>
                @can($usertype == 1 || $usertype == 6)
                    <li class="nav-item">
                        ...
                        aria-controls="Employee_complaint" aria-selected="false">{{trans('Complaint')}}</a>
                    </li>
                    <li class="nav-item">
                        ...
                        aria-controls="Employee_warning" aria-selected="false">{{trans('Warning')}}</a>
                    </li>
                @endcan
            </ul>
