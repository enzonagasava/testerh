                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="institution_name" id="institution_name"
                                       placeholder={{trans('School/University')}}
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="language_skill_id" id="language_skill_id" required
                                        class="form-control selectpicker"
                                        data-live-search="true" data-live-search-style="contains"
                                        title='{{__('Selecting',['key'=>trans('Language')])}}...'>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" data-dismiss="modal" id="close" aria-label="Close" class="close qualification-close"><i class="dripicons-cross"></i></button>
                </div>
                <div class="modal-body">
                    <h4 align="center" style="margin:0;">{{__('Are you sure you want to remove this data?')}}</h4>
                </div>
                <div class="modal-footer">
                    <button type="button" name="ok_button"  class="btn btn-danger qualification-ok">{{trans('OK')}}</button>
                    <button type="button" class="qualification-close btn btn-default" data-dismiss="modal">{{trans('Cancel')}}</button>
                </div>
            </div>
        </div>
    </div>
