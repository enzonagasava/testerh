    ...
    $('#create_allowance_record').click(function () {
        ...
        $('#allowance_amount').on('input change', function () {
    ...
    $(document).on('click', '.allowance_edit', function () {
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                $('#allowance_action_button').val('{{trans('Edit')}}');
