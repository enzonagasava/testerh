<section>
    ...
    <div class="mb-3">
        @can('set-salary')
            <button type="button" class="btn btn-info" name="create_record" id="create_allowance_record"><i
                        class="fa fa-plus"></i>Adicionar Valor</button>
        @endcan
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title">Adicionar</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="is_taxable" id="allowance_is_taxable" required
                                    ...
                                    <option value="1">{{trans('Taxable')}}</option>
                                    <option value="0">{{trans('Non-Taxable')}}</option>
                                </select>
                            </div>
                            <div class="col-md-6 form-group">
    ...
    <div class="modal fade confirmModal" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title">Adicionar</h2>
                ...
                <div class="modal-footer">
                    <button type="button" name="ok_button"  class="btn btn-danger allowance-ok">{{trans('OK')}}</button>
                    <button type="button" class="allowance-close btn btn-default" data-dismiss="modal">{{trans('Cancel')}}</button>
                </div>
            </div>
        </div>
    </div>
