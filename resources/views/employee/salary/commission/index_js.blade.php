   ...
   var table_table = $('#commission-table').DataTable({
    ...
    $('#create_commission_record').click(function () {
        ...
        $('#commission_action_button').val('{{trans('Add')}}');
        $('#commission_action').val('{{trans('Add')}}');
        $('#CommissionformModal').modal('show');
    });

    $('#commission_sample_form').on('submit', function (event) {
        event.preventDefault();
        if ($('#commission_action').val() == '{{trans('Add')}}') {
        ...
        if ($('#commission_action').val() == '{{trans('Edit')}}') {
            $.ajax({
    ...
    $(document).on('click', '.commission_edit', function () {
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                $('#commission_action_button').val('{{trans('Edit')}}');
                $('#commission_action').val('{{trans('Edit')}}');
                $('#CommissionformModal').modal('show');
            }
        })
    });
    ...
    $('.commission-ok').click(function () {
        ...
        $.ajax({
            url: target,
            beforeSend: function () {
                $('.commission-ok').text('{{trans('Deleting...')}}');
            },
            success: function (data) {
                setTimeout(function () {
                    $('.confirmModal').modal('hide');
