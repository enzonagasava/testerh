        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return '{{trans('Title')}}:' + row.loan_title + "<br>" + '{{__('Loan Type')}}:' + row.loan_type
                        + "<br>" + '{{trans('Reason')}}:' + row.reason;
                }
            },
            {
                data: 'loan_amount',
    ...
    $(document).on('click', '.loan_edit', function () {
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                $('#loan_action_button').val('{{trans('Edit')}}');
                $('#loan_action').val('{{trans('Edit')}}');
                $('#LoanformModal').modal('show');
            }
        })
    });
