                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="loan_type_id" required id="loan_type_id"
                                        ...
                                        title='{{__('Selecting',['key'=>trans('Loan Option')])}}...'>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="loan_title" id="loan_title" placeholder={{trans('Title')}}
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                @endif <input type="text" name="loan_amount" id="loan_amount"
                                              placeholder={{trans('Amount')}}
                                                      required class="form-control currency_format">
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" name="ok_button"  class="btn btn-danger loan-ok">{{trans('OK')}}</button>
                    <button type="button" class="loan-close btn btn-default" data-dismiss="modal">{{trans('Cancel')}}</button>
                </div>
            </div>
        </div>
    </div>
