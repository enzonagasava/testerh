    ...
    <div class="mb-3">
        @can('set-salary')
            <button type="button" class="btn btn-info" name="create_record" id="create_basic_salary_record"><i
                        class="fa fa-plus"></i>Adicionar Salário Básico</button>
        @endcan
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="payslip_type" id="payslip_type_edit" required class="selectpicker form-control" title="{{__('Selecting',['key'=>__('Payslip Type')])}}...">
                                    <option value="Mensal">{{__('Monthly Payslip')}}</option>
                                    <option value="Horario">{{__('Hourly Payslip')}}</option>
                                </select>
                            </div>
                            <div class="col-md-6 form-group">
                                @if(config('variable.currency_format')=='suffix')
                                ...
                                <input type="text" name="basic_salary" id="basic_salary_edit" placeholder="{{__('0.00')}}"  class="form-control currency_format">
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="ok_button" class="btn btn-danger basic-ok">{{trans('Yes')}}</button>
                    <button type="button" class="basic_salary-close btn btn-secondary" data-dismiss="modal">{{trans('Cancel')}}</button>
                </div>
            </div>
        </div>
      </div>
