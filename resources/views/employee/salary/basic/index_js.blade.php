    ...
    $('#create_basic_salary_record').click(function () {
        ...
        $('#basic_salary_action_button').val('{{trans('Add')}}');
        $('#basic_salary_action').val('{{trans('Add')}}');
        $('#basicSalaryformModal').modal('show');
        {{-- $('#basic_salary_edit').on('input change', function () {
    ...
    $('#basic_salary_sample_form').on('submit', function (event) {
        ...
        if ($('#basic_salary_action').val() == '{{trans('Add')}}') {

            var formData = new FormData(this);
            let salaryFormatted = $('#basic_salary_edit').val();
            let salaryRaw = salaryFormatted.replace(/[^0-9,]/g, '').replace(',', '.'); // Convert "R$ 1.234,56" to "1234.56"
            formData.set("basic_salary", salaryRaw);
        ...
        if ($('#basic_salary_action').val() == '{{trans('Edit')}}') {
            $.ajax({
    ...
    $(document).on('click', '.salary_basic_edit', function () {
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                $('#basic_salary_action_button').val('{{trans('Edit')}}');
                $('#basic_salary_action').val('{{trans('Edit')}}');
                $('#basicSalaryformModal').modal('show');
            }
        })
    });
