    ...
    $('#create_overtime_record').click(function () {
        ...
        $('#overtime_action_button').val('{{trans('Add')}}');
        $('#overtime_action').val('{{trans('Add')}}');
        $('#OvertimeformModal').modal('show');
    });

    $('#overtime_sample_form').on('submit', function (event) {
        event.preventDefault();
        if ($('#overtime_action').val() == '{{trans('Add')}}') {

            var fieldName = 'overtime_rate'
        ...
        if ($('#overtime_action').val() == '{{trans('Edit')}}') {
            $.ajax({
    ...
    $(document).on('click', '.overtime_edit', function () {
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                $('#overtime_action_button').val('{{trans('Edit')}}');
                $('#overtime_action').val('{{trans('Edit')}}');
                $('#OvertimeformModal').modal('show');
            }
        })
    });
    ...
    $('.overtime-ok').click(function () {
        ...
        $.ajax({
            url: target,
            beforeSend: function () {
                $('.overtime-ok').text('{{trans('Deleting...')}}');
            },
            success: function (data) {
                setTimeout(function () {
                    $('.confirmModal').modal('hide');
