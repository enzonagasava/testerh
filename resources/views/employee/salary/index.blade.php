            ...
            <ul class="nav nav-tabs vertical" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('salary_allowance.show',$employee)}}" id="salary_allowance-tab"
                       ...
                       aria-controls="Salary_allowance" aria-selected="false">Valor do Posto</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('salary_commission.show',$employee)}}" id="salary_commission-tab"
                       ...
                       aria-controls="Salary_commission" aria-selected="false">{{trans('Commissions')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('salary_loan.show',$employee)}}" id="salary_loan-tab"
                       ...
                       aria-controls="Salary_loan" aria-selected="false">{{trans('Loan')}}</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" id="salary_pension-tab"
                        ...
                        aria-controls="salary_pension" aria-selected="true">{{__('Pensão Salarial')}}
                    </a>
                </li>
                <!--/ New -->
            </ul>
                    ...
                    <form method="post" id="salary_pension_form" class="form-horizontal" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                @endif
                                <input type="text" min="0" name="pension_amount" id="pension_amount" placeholder="{{__('Amount')}}" required class="form-control currency_format" value="{{ $employee->pension_amount ?? '' }}">
                            </div>
                        </div>
...
-->
<div class="modal fade confirmModal" id="confirmModal" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">{{trans('Confirmation')}}</h2>
                <button type="button" class="bank-close btn" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <h4 align="center" style="margin:0;">{{__('Are you sure you want to remove this data?')}}</h4>
            </div>
            <div class="modal-footer">
                <button type="button" name="ok_button"  class="btn btn-danger document-ok">{{trans('OK')}}</button>
                <button type="button" class="bank-close btn btn-default" data-dismiss="modal">{{trans('Cancel')}}</button>
            </div>
        </div>
    </div>
</div>
