    ...
    $('#create_work_experience_record').click(function () {
        ...
        $('#work_experience_action_button').val('{{trans('Add')}}');
        $('#work_experience_action').val('{{trans('Add')}}');
        $('#WorkExperienceformModal').modal('show');
    });

    $('#work_experience_sample_form').on('submit', function (event) {
        event.preventDefault();
        if ($('#work_experience_action').val() == '{{trans('Add')}}') {
        ...
        if ($('#work_experience_action').val() == '{{trans('Edit')}}') {
            $.ajax({
    ...
    $('#work_experience_hidden_id').val(html.data.id);
                ...
                $('#work_experience_action_button').val('{{trans('Edit')}}');
                $('#work_experience_action').val('{{trans('Edit')}}');
                $('#WorkExperienceformModal').modal('show');
            }
        })
    });
    ...
    $('.experience-ok').click(function () {
        ...
        $.ajax({
            url: target,
            beforeSend: function () {
                $('.experience-ok').text('{{trans('Deleting...')}}');
            },
            success: function (data) {
                setTimeout(function () {
                    $('.confirmModal').modal('hide');
