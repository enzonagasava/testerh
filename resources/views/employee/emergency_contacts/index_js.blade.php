    ...
    $('#create_contact_record').click(function () {
        ...
        $('.modal-title').text("Adicionar Novo Contato");
        $('#contact_action_button').val('{{trans('Add')}}');
        $('#contact_action').val('{{trans('Add')}}');
        $('#ContactformModal').modal('show');
    });

    $('#contact_sample_form').on('submit', function (event) {
        event.preventDefault();
        if ($('#contact_action').val() == '{{trans('Add')}}') {
        ...
        if ($('#contact_action').val() == '{{trans('Edit')}}') {
            $.ajax({
    ...
    $(document).on('click', '.contact_edit', function () {
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                $('#contact_action_button').val('{{trans('Edit')}}');
                $('#contact_action').val('{{trans('Edit')}}');
                $('#ContactformModal').modal('show');
            }
        })
    });
    ...
    $('.contact-ok').click(function () {
        ...
        $.ajax({
            url: target,
            beforeSend: function () {
                $('.contact-ok').text('{{trans('Deleting...')}}');
            },
            success: function (data) {
                setTimeout(function () {
                    $('.confirmModal').modal('hide');
