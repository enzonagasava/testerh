        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title">{{trans('Add Contact')}}</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="work_phone" id="contact_work_phone"
                                       placeholder="{{trans('Work Phone')}}"
                                       class="form-control cellphone mb-2">
                                ...
                                <input type="text" name="personal_phone" id="contact_personal_phone"
                                       ...
                                       required class="form-control cellphone mb-2">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="contact-close btn btn-default" data-dismiss="modal">{{trans('Cancel')}}</button>
                </div>
            </div>
        </div>
    </div>
