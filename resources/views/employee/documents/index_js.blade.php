    ...
    $('#create_document_record').click(function () {
        ...
        $('#document_action_button').val('{{trans('Add')}}');
        $('#document_action').val('{{trans('Add')}}');
        $('#DocumentformModal').modal('show');
    });

    $('#document_sample_form').on('submit', function (event) {
        event.preventDefault();
        if ($('#document_action').val() == '{{trans('Add')}}') {
        ...
        if ($('#document_action').val() == '{{trans('Edit')}}') {
            $.ajax({
    ...
    $(document).on('click', '.document_edit', function () {
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                $('#document_action_button').val('{{trans('Edit')}}');
                $('#document_action').val('{{trans('Edit')}}');
                $('#DocumentformModal').modal('show');
            }
        })
    });
    ...
    $('.document-ok').click(function () {
        ...
        $.ajax({
            url: target,
            beforeSend: function () {
                $('.document-ok').text('{{trans('Deleting...')}}');
            },
            success: function (data) {
                setTimeout(function () {
                    $('.confirmModal').modal('hide');
