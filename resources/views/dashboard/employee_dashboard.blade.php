            ...
            <div class="row">
                ...
                <div class="col-9 col-md-10 mb-3">
                    ...
                    <a class="btn btn-default btn-sm" id="my_profile" href="{{route('profile')}}">
                        <i class="dripicons-user"></i> {{trans('Profile')}}
                    </a>
        ...
        <div class="container-fluid">
                ...
                <div class="col-md-3 mt-4">
                    <div class="d-flex wrapper count-title">
                        ...
                        <a href="{{route('announcements.index')}}">
                            <div class="text-center"><h4>{{ count($announcements) }} Comunicado</h4>
                            </div>
                            <p>{{ __('View Details') }}</p>
                        </a>
                    </div>
            ...
            {{-- <div class="row">
                <div class="col-md-4 mt-4">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="text-center">Licença</h3>
                        </div>
                ...
                {{-- <div class="col-md-4 mt-4">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="text-center">Viagem</h3>
                        </div>
                        <div class="d-flex justify-content-between">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        @foreach($holidays as $holiday)
                            <div><strong class="name blue-text">{{$holiday->event_name}}</strong>{{trans('From')}}
                                :{{$holiday->start_date}} {{trans('To')}}:{{$holiday->end_date}}</div>
                        @endforeach
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select name="travel_type_id" class="form-control selectpicker "
                                            ...
                                            title='{{__('Selecting',['key'=>trans('Arrangement')])}}...'>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" id="ticket_sample_form" class="form-horizontal"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label>{{trans('Select Priority')}}</label>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="subject" id="subject" class="form-control"
                                           placeholder="Ex.: Férias, Benefícios, Atestado e outros.">
                                </div>
                                ...
                                <div class="col-md-6 form-group hide_edit">
                                    <label>{{__('Ticket Attachments')}} <span class="badge">Somente PDF</span> </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        placeholder="Ex.: Solicito minhas férias para o período de 10/08 a 24/08, conforme combinado com meu gestor. Já organizei as tarefas pendentes.
                                        Ex.: Estou enviando atestado médico referente ao dia 25/07/2025, com afastamento de 2 dias (25 e 26 de julho), por orientação médica.
                                        O documento está anexado na solicitação."
                                                  rows="3"></textarea>
                                    </div>
                                </div>
...
<script>
    (function($) {
        ...
        $('#ticket_sample_form').on('submit', function (event) {
            event.preventDefault();
            let $inputs = $('#ticket_sample_form input, #ticket_sample_form select, #ticket_sample_form textarea');
            $.ajax({
                    ...
                    if (data.errors) {
                        ...
                        for (const campo in data.errors) {
                            if (data.errors.hasOwnProperty(campo)) {
                                data.errors[campo].forEach(function(mensagem) {
                                    html += '<p>' + mensagem + '</p>';
                                });
                                $inputs.filter('[name="' + campo + '"]').addClass('input-error');
                            }
                        }
                        html += '</div>';
