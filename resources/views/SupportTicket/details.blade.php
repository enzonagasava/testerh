                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-1">
                                <h6 class="text-muted">Detalhes da Solicitação</h6>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="text-muted">{{trans('Company')}} : {{$company->company_name}}</div>
                                <div class="text-muted">{{trans('Department')}} : {{$department->department_name}}</div>
                                <div class="text-muted">{{trans('Priority')}} : {{$ticket->ticket_priority}}</div>
                                <div class="text-muted">{{trans('Date')}} :{{$ticket->created_at}}</div>
                            </div>
                            <hr>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="details-tab" data-toggle="tab" href="#Details"
                                       ...
                                       aria-selected="true">{{trans('Details')}}</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="notes-tab" data-toggle="tab" href="#Notes" role="tab"
                                       aria-controls="Notes" aria-selected="false">Setor</a>
                                </li>
                            </ul>
...
@push('scripts')
<!-- Adicione estas linhas antes do seu script para garantir que DataTables está carregado -->
...
<script type="text/javascript">
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            // Variáveis do PHP para JS
            let ticket_status = @json($ticket->ticket_status);
            let ticket_remarks = @json($ticket->ticket_remarks);
            let assigned = @json($name);
            ...
            // Submit formulário assigned_form via AJAX
            ...
            // Submit formulário details_form via AJAX
            ...
            // Submit formulário comments_form via AJAX
            ...
            // Submit formulário note_form via AJAX
            ...
            // Deletar comentário ao clicar no botão .delete-comment
            $(document).on('click', '.delete-comment', function () {
                if (confirm('{{ __("Delete Selection", ["key" => trans("Comments")]) }}')) {
