       ...
       <div class="modal-body">
           ...
           <form method="get" id="payment_form" class="form-horizontal" >
                  ...
                  <div class="row">
                   ...
                   <div class="col-md-12">
                       <div class="form-group">
                           <span><strong>{{trans('NOTE')}}:</strong> {{__('Total Allowance,Commissions,Total Loan,Total Overtime,Statutory deductions,Other Payment, Pension are not editable.')}}</span>
                       </div>
                   </div>

               <div class="form-actions"> <button  type="submit" class="btn btn-primary"><i class="fa fa fa-check-square-o"></i> {{trans('Pay')}}</button>
               </div>
                  </div>
           </form>
       </div>
