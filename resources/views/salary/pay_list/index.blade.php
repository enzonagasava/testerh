                                ...
                                <div class="text-center">
                                    <div class="form-group">
                                        <div class="form-actions">
                                            <button id="payslip_filter" type="submit" class="filtering btn btn-primary"> <i class="fa fa-search"></i> {{trans('Search')}} </button>
                ...
                let table_table = $('#pay_list-table').DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: function (data) {
                                if (data == 1) {
                                    return "<td><div class = 'badge badge-success'>{{trans('Paid')}}</div>"
                                } else {
                                    return "<td><div class = 'badge badge-danger'>{{trans('Unpaid')}}</div>"
                                }
                            }
                        },
                        {
