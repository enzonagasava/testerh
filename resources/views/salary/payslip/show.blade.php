                                ...
                                <div class="table-responsive">
                                    <table class="table  table-bordered dataTable no-footer">
                                        ...
                                        <tr>
                                            ...
                                            <td><strong class="help-split">{{trans('Phone')}}
                                                    : </strong>{{$employee->contact_no}}</td>
                                        </tr>
                                        <tr>
                                            <td><strong class="help-split">{{trans('Designation')}}
                                                    : </strong>{{$employee->designation->designation_name}}</td>
                                            <td><strong class="help-split">{{trans('Department')}}
                                                    : </strong>{{$employee->department->department_name}}</td>
                                            <td><strong class="help-split">{{trans('Company')}}
                        ...
                        <div id="accordion">
                            ...
                            @if($payslip->allowances)
                                <div class="card mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                ...
                                                                aria-expanded="false">
                                            <strong>{{trans('Allowances')}}</strong> </a></div>
                                        ...
                                        <div class="box-body">
                                            <div class="table-responsive">
                                                <table class="table  table-bordered dataTable no-footer">
                                                    ...
                                                    @endforeach
                                                    <tr>
                                                        <td><strong>{{trans('Total')}}:</strong> <span
                            ...
                            @if($payslip->commissions)
                                <div class="card mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                ...
                                                                aria-expanded="false">
                                            <strong>{{trans('Commissions')}}</strong> </a></div>
                            ...
                            @if($payslip->loans)
                                <div class="card  mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                ...
                                                                aria-expanded="false">
                                            <strong>{{trans('Loan')}}</strong> </a></div>
                            ...
                            <div class="card mb-2">
                                <div class="card-header"><a class="text-dark collapsed d-block"
                                                            ...
                                                            aria-expanded="false">
                                        <strong>{{__('Informações sobre licenças anuais')}} (Year - {{date('Y')}})</strong> </a></div>
                            ...
                            @if($payslip->overtimes)
                                <div class="card mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                ...
                                                                aria-expanded="false">
                                            <strong>{{trans('Overtime')}}</strong> </a></div>
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered mb-0">
                                                    ...
                                                    <tfoot>
                                                    <tr>
                                                        <td colspan="5" align="right"><strong>{{trans('Total')}}
                                                                :</strong></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table no-footer mt-0">
                                            ...
                                            @isset($allowance_total)
                                                <tr>
                                                    <td><strong>Subsídio total:</strong> <span
                                            ...
                                            @isset($payslip->pension_amount )
                                                <tr>
                                                    <td><strong>Valor da pensão:</strong> <span
                                            ...
                                            @isset($loan_total)
                                                <tr>
                                                    <td><strong>A pagar mensalmente :</strong> <span
                                                                class="pull-right">{{$loan_total ?? 0.00}}</span></td>
                                                </tr>
                                            @endisset
                                            @isset($deduction_total)
                                                <tr>
                                                    <td><strong>Dedução total:</strong> <span
                                            ...
                                            @isset($other_payment_total)
                                                <tr>
                                                    <td><strong>Total de outros pagamentos:</strong> <span
                                            ...
                                            @isset($overtime_total)
                                                <tr>
                                                    <td><strong>Horas extras totais:</strong> <span
                                            ...
                                            <tfooter>
                                                <tr>
                                                    @if(config('variable.currency_format') =='suffix')
                                                        <th class="text-dark"><strong>A ser Pago:</strong> <span
