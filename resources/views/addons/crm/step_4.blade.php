...
<body>
    <div class="col-md-6 offset-md-3">
        <div class='wrapper'>
            <header>
                <img src="{{ asset('install-assets/images/peopleprocrm.png')}}" alt="Logo"/>
            ...
            <p>
                    ...
                    You have successfully installed PeoplePro CRM.</h5><br>
                    Please  <strong><a href="{{ url('/') }}" target="__blank">Click Here</a></strong> to visit the app.
                </p>
            </div>
            <hr>
