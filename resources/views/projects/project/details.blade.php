            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title">{{trans('Status')}}</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select name="bug_status" id="bug_status" class="form-control selectpicker "
                                        ...
                                        <option value="solved">{{trans('Solved')}}</option>
                                    </select>
                                </div>
                            ...
                            <div class="collapse show" id="collapseExample">
                                <div class="table-responsive">
                                    ...
                                    <table class="table mb-0">
                                        <thead>
                                            <th scope="row">{{trans('Employees')}}*</th>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 form-group show-edit">
                                                    ...
                                                    <select name="project_status" id="project_status"
                                                        ...
                                                        <option value="deferred">{{trans('Deferred')}}</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <select name="project_priority" id="project_priority"
                                                        ...
                                                        <option value="highest">{{trans('Highest')}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    (function($) {
        ...
        $(document).on('click', '.delete-discussion', function () {
            ...
            if (confirm('{{__('Delete Selection',['key'=>trans('Discussions')])}}')) {
        ...
        $(document).on('click', '.delete-bug', function () {
            ...
            if (confirm('{{__('Delete Selection',['key'=>trans('Bugs')])}}')) {
        ...
        $(document).one('click', '.delete-file', function () {
            ...
            if (confirm('{{__('Delete Selection',['key'=>trans('Files')])}}')) {
        ...
        $(document).one('click', '.delete-task', function () {
            ...
            if (confirm('{{__('Delete Selection',['key'=>trans('Tasks')])}}')) {
