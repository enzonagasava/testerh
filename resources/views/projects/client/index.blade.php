...
@section('content')
    ...
    <section>
        ...
        <div class="container-fluid mb-3">
            @can('store-client')
                <button type="button" class="btn btn-info" name="create_record" id="create_record"><i class="fa fa-plus"></i> Adicionar Cliente</button>
            @endcan
            @can('delete-client')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="contact_no" id="contact_no"
                                       ...
                                       class="form-control cellphone" value="{{ trans('contact_no') }}">
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="city" id="city" placeholder="{{trans('City')}}"
                                       class="form-control">
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="zip" id="zip" placeholder="{{trans('ZIP')}}"
                                       class="form-control">
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="file" id="profile_photo"
                                       ...
                                       name="profile_photo"
                                       placeholder={{trans('Upload')}} {{trans('Photo')}}>
                            </div>
                            ...
                            <div class="col-md-6 form-group custom-control custom-checkbox hide-add">
                                <input type="checkbox" class="custom-control-input" name="is_active" id="is_active"
                                       value="1" checked>
                                <label class="custom-control-label" for="is_active">{{trans('Active')}}</label>
                            </div>
...
<script type="text/javascript">
    (function($) {
        ...
        $(document).on('click', '#bulk_delete', function () {
            ...
            if (id.length > 0) {
                if (confirm('{{__('Delete Selection',['key'=>trans('Client')])}}')) {
                    $.ajax({
