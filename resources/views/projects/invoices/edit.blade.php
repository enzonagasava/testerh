                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="project_id" id="project_id" class="form-control selectpicker "
                                            ...
                                            title='{{__('Selecting',['key'=>trans('Project')])}}...'>
                                ...
                                <div id="{{$invoice_item->id}}" class="item">
                                    ...
                                    <div class="row">
                                        <div class="form-group mb-1 col-sm-12 col-md-3">
                                            <label for="item_name">{{trans('Item')}}</label>
                                            <br>
                                            <input type="text" required class="form-control item_name"
                                                   name="item_name[]" placeholder="{{trans('Item')}}"
                                                   value="{{$invoice_item->item_name}}">
                                        </div>
                                        <div class="form-group mb-1 col-sm-12 col-md-1">
                                            <label for="qty_hrs" class="cursor-pointer">{{trans('Qty')}}</label>
                                            <br>
                                        ...
                                        <div class="form-group mb-1 col-sm-12 col-md-1">
                                            <label for="tax_type">{{trans('Tax')}}</label>
                                            <br>
                                            ...
                                            <td colspan="2">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <strong>{{trans('Discount')}}</strong></td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select name="discount_type"
                                                                    ...
                                                                    <option value="0"> {{trans('Flat')}}</option>
