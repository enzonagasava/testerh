...
<form method="post" id="tax_type_form" class="form-horizontal" >
    ...
    <div class="col-md-4 form-group">
        ...
        <input type="text" name="rate" id="rate"  required class="form-control required currency_format"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 id="TaxModalLabel" class="modal-title">{{trans('Edit')}}</h5>
            ...
            <div class="modal-body">
                <form method="post" id="tax_type_form_edit" class="form-horizontal" >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        @endif
                        <input type="text" name="rate_edit" id="rate_edit" required class="form-control currency_format"
                               placeholder="{{__('Tax Rate')}}">
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
