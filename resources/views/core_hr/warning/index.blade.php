                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="selectpicker form-control"
                                        ...
                                        <option value="unsolved">{{trans('Unsolved')}}</option>
                                    </select>
                                </div>
                            </div>
...
<script type="text/javascript">
    (function($) {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data) {
                            if (data == 'solved') {
                                return "<td><div class = 'badge badge-success'>{{trans('Solved')}}</div>"
                            } else {
                                return "<td><div class = 'badge badge-danger'>{{trans('Unsolved')}}</div>"
                            }
                        }
                    },
                    {
        ...
        $(document).on('click', '#bulk_delete', function () {
            ...
            if (id.length > 0) {
                if (confirm('{{__('Delete Selection',['key'=>trans('Warning')])}}')) {
                    $.ajax({
