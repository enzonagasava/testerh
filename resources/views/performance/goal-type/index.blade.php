...
<section>
    ...
    <div class="container-fluid mb-3">
        ...
        <h4 class="font-weight-bold mt-3">@lang('Goal Type')</h4>
        <div id="success_alert" role="alert"></div>
        <br>

        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="fa fa-plus mr-1"></i> {{__('Add New Type')}}</button>
        <button type="button" class="btn btn-danger" name="bulk_delete" id="bulk_delete"><i class="fa fa-minus-circle mr-1"></i> {{__('Bulk Delete')}}</button>
