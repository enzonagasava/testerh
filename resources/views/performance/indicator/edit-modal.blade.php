    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="createModalLabel"><b>@lang('Edit Indicator')</b></h5>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <select name="company_id" id="companyIdEdit" class="form-control selectpicker dynamic" data-live-search="true" data-live-search-style="contains"
                        data-dependent="designation_name" title='{{__('Selecting',['key'=>trans('Company')])}}...'>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                          <select name="customer_experience" id="customerExperienceEdit"
                              ...
                              <option value="None">Ainda não avaliou</option>
                              <option value="Beginner">Iniciante</option>
                              <option value="Intermidiate">Intermediário</option>
                              <option value="Advanced">Avançado</option>
                              <option value="Expert/Leader">Especialista/Líder</option>
                          </select>
                      </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                          <select name="professionalism" id="professionalismEdit"
                              class="form-control selectpicker dynamic" data-live-search="true"
                              data-live-search-style="contains">
                              <option value="None" selected>Ainda não avaliou</option>
                              <option value="Beginner">Iniciante</option>
                              <option value="Intermidiate">Intermediário</option>
                              <option value="Advanced">Avançado</option>
                              <option value="Expert/Leader">Especialista/Líder</option>
