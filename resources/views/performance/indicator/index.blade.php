...
<section>
    ...
    <div class="container-fluid mb-3">
        <h4 class="font-weight-bold mt-3">@lang('Performance Indicator')</h4>
        ...
        <button type="button" class="btn btn-danger" name="bulk_delete" id="bulk_delete"><i class="fa fa-minus-circle"></i> {{__('Delete')}}</button>
    </div>
