    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="createModalLabel"><b>@lang('Add New')</b></h5>
                ...
                <div class="row">
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="target_achievement" id="targetAchievement" placeholder="@lang('Target Achievement')">
                          </div>
                      </div>
                      <div class="col-md-12">
                          <div class="form-group">
                              <label><b>@lang('Description')</b></label>
                              <textarea class="form-control" name="description" id="description" cols="30" rows="5" placeholder="@lang('Description')"></textarea>
                          </div>
                      </div>
                      <div class="col-md-6">
                          <div class="form-group">
                              <label><b>@lang('Start Date') &nbsp;<span class="text-danger">*</span></b></label>
                              <input type="text" class="form-control"  name="start_date" id="start_date" placeholder="@lang('Start Date')">
                          </div>
                      </div>
                      <div class="col-md-6">
                          <div class="form-group">
                              <label><b>@lang('End Date') &nbsp;<span class="text-danger">*</span></b></label>
                              <input type="text" class="form-control"  name="end_date" id="end_date" placeholder="@lang('End Date')">
                          </div>
                      </div>
                </div>
