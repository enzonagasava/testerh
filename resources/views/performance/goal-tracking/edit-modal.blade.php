  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="createModalLabel"><b>@lang('Edit Goal Tracking')</b></h5>
      ...
      <div class="modal-body" id="edit-body">
        ...
        <form method="POST" id="updatetEditForm">
          ...
          <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label><b>@lang('Goal Type')</b></label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label><b>@lang('Subject')</b></label>
                        <input type="text" class="form-control" name="subject" id="subjectEdit">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label><b>@lang('Target Achievement')</b></label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="status" id="statusEdit" class="form-control selectpicker dynamic"
                              data-live-search="true" data-live-search-style="contains">
                              <option value="Not Started"><b>Não iniciado</b></option>
                              <option value="In Progress"><b>Em progresso</b></option>
                              <option value="Completed"><b>Completo</b></option>
                        </select>
                    </div>
                </div>
          </div>
