...
<section>
    ...
    <div class="container-fluid mb-3">
        <h4 class="font-weight-bold mt-3">@lang('Goal Tracking')</h4>
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data) {
                        if (data !== null) {
                            if (data > 70) {
                                return data + '% {{ __("complete") }}<div class="progress"><div class="progress-bar green" role="progressbar" style="width: ' + data + '%" aria-valuenow="' + data + '" aria-valuemin="0" aria-valuemax="100"></div></div>'
                            } else if (data > 50) {
                                return data + '% {{ __("complete") }}<div class="progress"><div class="progress-bar yellow" role="progressbar" style="width: ' + data + '%" aria-valuenow="' + data + '" aria-valuemin="0" aria-valuemax="100"></div></div>'
                            } else {
                                return data + '% {{ __("complete") }}<div class="progress"><div class="progress-bar red" role="progressbar" style="width: ' + data + '%" aria-valuenow="' + data + '" aria-valuemin="0" aria-valuemax="100"></div></div>'
                            }
                        } else {
                            return 0 + '% {{ __("complete") }}'
                        }
                    }
                },
                {
