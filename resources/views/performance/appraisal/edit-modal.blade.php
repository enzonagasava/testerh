    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="createModalLabel"><b>@lang('Edit Appraisal')</b></h5>
          ...
          <form action="" method="POST" id="updatetForm">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    data-live-search="true" data-live-search-style="contains"  title='{{__('Selecting',['key'=>trans('Company')])}}'>
            ...
            <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 col-form-label"><b>@lang('Employee')</b></label>
                <div class="col-sm-6" id="designation-selection">
                    <select name="employee_id" id="employeeIdEdit" class="form-control selectpicker" data-live-search="true" data-live-search-style="contains"  title='{{__('Selecting',['key'=>trans('Employee')])}}'>

                    </select>
                </div>
            </div>
            <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 col-form-label"><b>@lang('Select Date')</b></label>
                <div class="col-sm-6" id="designation-selection">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                          <select name="customer_experience" id="customerExperienceEdit"
                              ...
                              <option value="Intermidiate">@lang('Intermidiate')</option>
                              <option value="Advanced">@lang('Advanced')</option>
                              <option value="Expert/Leader">@lang('Expert/Leader')</option>
                          </select>
                      </div>
                  </div>
                  <div class="form-group row">
            ...
            <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 col-form-label"><b>@lang('Remarks')</b></label>
                <div class="col-sm-12">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary" id="update-button">@lang('Update')</button>
