    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="createModalLabel"><b>@lang('Give Performance Appraisal')</b></h3>
            ...
            <div class="modal-body">
                <form action="" method="POST" id="submitForm">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6" id="designation-selection">
                            <select name="employee_id" id="employeeId" class="form-control selectpicker"
                                data-live-search="true" data-live-search-style="contains" data-first_name="first_name"
                                data-last_name="last_name" title='{{__('Selecting',['key'=>trans('Employee')])}}'>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6" id="designation-selection">
                            <input type="text" class="form-control"  name="date" id="date" placeholder="@lang('Select Date')">
                        </div>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <textarea name="remarks" id="remarks" rows="5" class="form-control" placeholder="@lang('Remarks')"></textarea>
                        </div>
                    </div>
