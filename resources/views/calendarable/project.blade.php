                ...
                <form method="post" id="project_sample_form" class="form-horizontal" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="title" id="project_title" required class="form-control" placeholder="{{trans('Title')}}">
                        </div>

                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="project_client_id">{{trans('Client')}}*</label>
                                <select name="client_id" id="project_client_id"
                                        class="form-control selectpicker dynamic"
                                        data-live-search="true" data-live-search-style="contains"
                                        title='{{__('Selecting',['key'=>trans('Client')])}}...'>
                        ...
                        <div class="col-md-6 form-group">
                            <label for="project_priority" >{{trans('Priority')}}</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="project_summary" >{{trans('Summary')}}</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="project_company_id">{{trans('Company')}}</label>
