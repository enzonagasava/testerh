            ...
            $('#leave_sample_form').on('submit', function (event) {
               ...
               let dayDiff = 0;
                ...
                if (start_date && end_date) {
                 ...
                 // Convertendo o diff_date_hidden para inteiro.
                $('#diff_date_hidden').val(parseInt(dayDiff));
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="list-group" id="list_group">
                                @can('store-holiday')
                                    <button class="btn btn-default mb-2 calendar-options text-green" data-record=0 type="button"> <i class="dripicons-brightness-max"></i>  {{trans('Holidays')}}
                                    </button>
                                @endcan
                                @can('store-leave')
                                    <button class="btn btn-default mb-2 calendar-options text-aqua " data-record="1" type="button"><i class="dripicons-mail"></i> Adicionar Licença
                                    </button>
                                @endcan
                                @can('store-travel')
                                ...
                                @endcan
                                @can('store-training')
                                    <button class="btn btn-default mb-2 calendar-options text-yellow " data-record="3" type="button"><i class="dripicons-trophy"></i>  {{trans('Trainings')}}
                                    </button>
                                @endcan
                                @can('store-project')
                                    <button class="btn btn-default mb-2 calendar-options text-purple " data-record="4" type="button"><i class="dripicons-to-do"></i> {{trans('Projects')}}
                                    </button>
                                @endcan
                                @can('store-task')
                                    <button class="btn btn-default mb-2 calendar-options text-maroon " data-record="5" type="button"><i class="dripicons-checklist"></i> {{trans('Tasks')}}
                                    </button>
                                @endcan
                                @can('store-event')
                                    <button class="btn btn-default mb-2 calendar-options text-navy " data-record="6" type="button"><i class="dripicons-calendar"></i> {{trans('Events')}}
                                    </button>
                                @endcan
                                @can('store-meeting')
                                    <button class="btn btn-default mb-2 calendar-options text-teal " data-record="7" type="button"><i class="dripicons-clock"></i> {{trans('Meetings')}}
                                    </button>
                                @endcan
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel"> {{trans('Leave Info')}}</h4>
