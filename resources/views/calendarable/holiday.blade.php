                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="is_publish" id="holiday_is_publish" class="form-control selectpicker "
                                    ...
                                    <option value="" disabled selected>{{__('Selecting',['key'=>__('Status')])}}...</option>
                                    <option value="1">{{__('Unpublished')}}</option>
                        ...
                        <div class="container">
                            <div class="form-group" align="center">
                                <input type="submit" name="action_button"  class="btn btn-warning" value={{}} />
                            </div>
                        </div>
                    </div>
