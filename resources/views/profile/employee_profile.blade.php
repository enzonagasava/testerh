                                    ...
                                    <ul class="nav nav-tabs vertical" id="myTab" role="tablist">
                                        ...
                                        {{-- <li class="nav-item">
                                            <a class="nav-link" href="#Immigration"
                                               ...
                                               aria-selected="false">{{trans('Immigration')}}</a>
                                        </li> --}}
                                        <li class="nav-item">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 form-group">
                                                            ...
                                                            <select name="gender" id="gender"
                                                                ...
                                                                <option value="Masculino">{{trans('Male')}}</option>
                                                                <option value="Feminino">{{trans('Female')}}</option>
                                                                <option value="Outros">{{trans('Other')}}</option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4 form-group">
                                                            ...
                                                            <select name="marital_status" id="marital_status"
                                                                ...
                                                                <option value="divorced">{{trans('Divorced/Separated')}}</option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4 form-group">
                                                            <label>{{trans('State/Province')}} </strong>
                                                            </label>
