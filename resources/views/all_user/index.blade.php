...
@section('content')
    <section>
                    ...
                    @can('store-user')
                        <div class="dropdown mr-1">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="#" name="create_record" id="create_record">Adicionar Administrador</a>
                                @endif
                                {{-- <a class="dropdown-item" href="{{url('/staff/employees')}}#formModal">Adicionar Funcionário</a> --}}

                                {{-- @if ($isCrmModuleExist)
                                    <a class="dropdown-item" href="{{url('/clients')}}#formModal">Adicionar Cliente</a>
                                @else
                                    <a class="dropdown-item" href="{{url('/project-management/clients')}}#formModal">Adicionar Cliente</a>
                                @endif --}}
                            </div>
                        </div>
                    @endcan
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title">Adicionar Administrador</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label>{{trans('Username')}} <span class="text-danger">*</span></label>
                                    <input type="text" name="username" id="username"
                                           placeholder="{{__('Unique Value',['key'=>trans('Name')])}}"
                                    ...
                                    <select name="company_id[]" id="company_id" class="form-control" multiple>
                                        @foreach ($companies as $company)
                                            <option value="{{ $company->id }}"
                                                {{ in_array($company->id, $userCompanies ?? []) ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 form-group">
                                    <label>{{trans('Phone')}} <span class="text-danger">*</span></label>
                                    <input type="text" name="contact_no" id="contact_no"
                                           placeholder="{{trans('Phone')}}" required
                                           class="form-control cellphone" value="{{ old('contact_no') }}">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>{{trans('Password')}} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="file" id="profile_photo"
                                           ...
                                           name="profile_photo" placeholder="{{__('Upload',['key'=>trans('Photo')])}}">
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label"
                                                   for="is_active_add">{{trans('Active')}}</label>
                                        </div>
                                        <div class="col-md-9">
        ...
        <div id="editModal" class="modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div id="modal-errors-container"></div>
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title">{{trans('Edit')}}</h5>
                        <button type="button" data-dismiss="modal" id="close" aria-label="Close" class="close"><i class="dripicons-cross"></i></button>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" id="form_edit" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label>Empresas <span class="text-danger">*</span></label>
                                    <select name="company_id[]" id="company_id_edit" class="form-control" multiple>
                                        @foreach ($companies as $company)
                                            <option value="{{ $company->id }}">
                                                {{ $company->company_name }}
                                            </option>
                                ...
                                <div class="col-md-6 form-group">
                                    <br>
                                        <div class="col-sm-3 form-group custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="is_active"
                                                   id="is_active_edit" value="1" @checked(old('is_active', $user->is_active ?? false))>
                                            <input type="hidden" name="is_active" value="0">
                                            <label class="custom-control-label"
                                                   for="is_active_edit">{{trans('Active')}}</label>
                                        </div>
                                </div>
                                        <div class="col-sm-9">
                                            ...
                                            <input type="submit" name="action_button" id="action_button_edit"
                                                   class="btn btn-primary btn-block" value="{{trans('Edit')}}"/>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    (function($) {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data) {
                            if (data == '1') {
                                return "<td><div class = 'badge badge-success'>{{trans('Active')}}</div>"
                            } else {
                                return "<td><div class = 'badge badge-danger'>{{trans('Inactive')}}</div>"
                            }
                        }
                    },
                    {
        ...
        $('#form_edit').on('submit', function (event) {
            ...
            formData.set('is_active', $('#is_active_edit').prop('checked') ? 1 : 0);
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.errors) {
                        html = '<div class="alert alert-danger">';
                        // Itera sobre as chaves do objeto errors
                        $.each(data.errors, function (field, messages) {
                            // messages é um array de mensagens para o campo
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (html) {
                    ...
                    $('#is_active_edit').prop('checked' , html.data.is_active == 1);
                    ...
                    $('#company_id_edit').val(html.company_user).trigger('change');
                    $('#hidden_id_edit').val(html.data.id);
                    $('#action_button_edit').val('{{trans('Edit')}}');
                    $('#action_edit').val('{{trans('Edit')}}');
        ...
        $(document).on('click', '#bulk_delete', function () {
            ...
            if (id.length > 0) {
                if (confirm('{{__('Delete Selection',['key'=>trans('User')])}}')) {
                    $.ajax({
