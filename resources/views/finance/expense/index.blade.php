                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{trans('Account')}}*</label>&nbsp;<span
                                            id="balance"></span>
                            ...
                            <div class="col-md-6 form-group">
                                @if(config('variable.currency_format')=='suffix')
                                    <label>{{trans('Amount')}} ({{config('variable.currency')}}) *</label>
                                @else
                                    <label>({{config('variable.currency')}}) {{trans('Amount')}} *</label>
                                @endif
                                <input type="text" name="amount" id="amount" required class="form-control currency_format"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="payee_id" id="payee_id" class="form-control selectpicker"
                                            data-live-search="true" data-live-search-style="contains"
                                            title='{{__('Selecting',['key'=>trans('Payer')])}}...'>
                            ...
                            <div class="col-md-6 form-group">
                                <label>{{trans('Attach')}} {{trans('File')}} </label>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table  table-bordered">
                                    ...
                                    <tr>
                                        <th>{{trans('Expense')}} {{trans('File')}}</th>
