    ...
    <div class="col-md-12 p-3">
        ...
        <div class="col-md-3 p-3">
            <button id="print-btn" type="button" class="btn btn-default btn-sm d-print-none"><i
                        class="fa fa-print"></i> {{trans('Print')}}</button>
        </div>

        <div class="card invoice_details">
            <div class="card-body" id="invoice_details">
                <h2>{{$company->company_name}}
                    <small class="pull-right">{{trans('Date')}}-{{ date('d-m-Y') }}</small>
                </h2>
                <hr>

                <div class="row">
                    <div class="col-sm-4 company-col"> {{trans('From')}}
                        <address>
                    ...
                    <div class="col-sm-4 client-col"> {{trans('To')}}
                        <address>
                    ...
                    <!-- /.col -->
                    <div class="col-sm-4 invoice-col"><b>{{trans('Invoice')}}
                            # {{$invoice->invoice_number}}</b><br>
                        <br>
                        <b>{{trans('Date')}}: </b>{{$invoice->invoice_date}} <br>
