        ...
        <div class="d-flex flex-column flex-md-row align-items-center pt-2 pb-2">
            ...
            <div class="collapse navbar-collapse show" id="navbarTogglerDemo03">
                <nav class="my-2 my-md-0 mr-md-3 text-right">
                    {{-- <a class="p-2 text-dark" href="{{route('home.front')}}">{{trans('Home')}}</a> --}}
                    <a class="p-2 text-dark" href="{{route('jobs')}}">{{trans('Jobs')}}</a>
                    {{-- <a class="p-2 text-dark" href="{{route('about.front')}}">{{trans('About')}}</a> --}}
                    {{-- <a class="p-2 text-dark" href="{{route('contact.front')}}">{{trans('Contact')}}</a> --}}
                </nav>
            </div>
        </div>
    </div>
