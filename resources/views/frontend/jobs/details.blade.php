    ...
    <div class="container">
        <div class="d-flex justify-content-between">
            ...
            <button class="btn btn-primary" id="apply_job">
                {{trans('Apply')}} <i class="dripicons-arrow-thin-right"></i>
            </button>
        </div>
    </div>
</section>
        ...
        <div class="col-md-4 offset-md-1 mt-4">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <h6 class="card-subtitle mt-2 text-muted">{{trans('Experience')}}</h6>
                    <p class="card-text">{{$job_post->jobExperience->title}}</p>
                    <h6 class="card-subtitle mt-2 text-muted">{{trans('Vacancy')}}</h6>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                @csrf
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="email" name="email" id="email"  placeholder="{{trans('Email')}}" required class="form-control">
                            </div>

                            <div class="col-md-6 form-group">
                                <label for="email">{{trans('Phone')}} *</label>
                                <input type="text" name="phone" id="phone" placeholder="{{trans('Phone')}}" required class="form-control">
                            </div>

                            <div class="col-md-12 form-group">
                                <label for="email">{{trans('Address')}} </label>
                                <textarea name="address" id="address" placeholder="{{trans('Address')}}" class="form-control" cols="30" rows="3"></textarea>
                                {{-- <input type="text" name="address" id="address" placeholder="{{trans('Address')}}" class="form-control"> --}}
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <label for="fb_id">{{__('Facebook Profile')}} ({{trans('Optional')}})</label>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <label for="linkedin_id">{{__('Linkedin Profile')}} ({{trans('Optional')}})</label>
                    ...
                    <input type="submit" name="action_button" id="action_button" class="btn btn-warning btn-block btn-lg" value="{{trans('Apply')}}"/>
                </form>
            </div>
        </div>
    </div>
